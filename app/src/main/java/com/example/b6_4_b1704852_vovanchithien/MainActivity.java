package com.example.b6_4_b1704852_vovanchithien;
 ...
 ************************************************************************/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String URL = "http://192.168.1.37/Buoi_6/thongtin.php";
        String URL2 = "https://www.youtube.com/watch?v=g9nHV_kLeu4";
        edtURL.setText(URL2);

        JSONObject postParams = new JSONObject();
        try
        {
            postParams.put("mssv", "b1704852");
        }
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PostComponent postRequest = new PostComponent(edtURL.getText().toString(), postParams);
                new GetServerResponse().execute(postRequest);
            }
        });
    }
